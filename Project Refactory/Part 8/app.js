...
function main() {
    ...
    saveToCustomBtn.addEventListener('click', handleSaveToCustomBtn(customcolorParent, colorModeHexInp));
...
function handleSaveToCustomBtn(customcolorParent,inputHex){
    ...
    removeChilden(customcolorParent);
